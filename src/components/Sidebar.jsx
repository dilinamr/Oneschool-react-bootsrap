...
<Nav defaultActiveKey="/" className="flex-column">
            ...
            <Nav.Link href="/students"> <FontAwesomeIcon icon={faUserGraduate} /><span className="d-none d-md-inline">Students</span></Nav.Link>
            <Nav.Link href="/staff"><FontAwesomeIcon icon={faUser} /><span className="d-none d-md-inline">Staff</span></Nav.Link>
            <Nav.Link href="/accounts"><FontAwesomeIcon icon={faSackDollar} /><span className="d-none d-md-inline">Accounts</span></Nav.Link>
